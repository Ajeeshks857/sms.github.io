...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="maths" placeholder="maths">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Science</label>
    <input type="number" class="form-control" name="science" placeholder="science">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">History</label>
    <input type="number" class="form-control" name="history" placeholder="history">
  </div>
